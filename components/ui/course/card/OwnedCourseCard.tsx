...
interface ILocalProps extends IChildrenProp {
  course: object;
}
...
export default function OwnedCourseCard({ children, course }: ILocalProps) {
  const stateColor = STATE_COLORS[course.state as keyof unknown];
